#!/usr/bin/env python3
"""
Recording Orchestration Script for Phase 2B Candidate 4 Corrected (R2)

Trajectory: Candidate 4 (Yaw Sweep + Sustained Forward Translation - FIXED MASK 3576)
  - Family: F9 (Level 2)
  - Duration: 20.0s after takeoff readiness
  - World: agriculture.world
  - Output Dataset: results/datasets/phase2b_candidate4_L2_R2
...
def record_candidate4_corrected():
    run_id = "phase2b_candidate4_L2_R2"
    dataset_dir = f"results/datasets/{run_id}"

    print("==========================================================================")
    print("PHASE 2B DATASET RECORDER — Candidate 4 Corrected (Mask 3576, R2)")
    print("==========================================================================")
    ...
    # 5. Launch Motion Generator (F9 L2 = Yaw Sweep + Translation, mask 3576)
    ...
    kill_all_sim_processes()
    print(f"\n>>> CANDIDATE 4 CORRECTED DATASET '{run_id}' RECORDING COMPLETE! <<<")


if __name__ == '__main__':
    record_candidate4_corrected()
